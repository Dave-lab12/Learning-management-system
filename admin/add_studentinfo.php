		                        ...
		                        <div class="block">
									...
									<a href="students.php"><i class="icon-arrow-left"></i> Back</a>
										...
										<div class="control-group">
											...
											<div class="controls">
											<input type="text" class="span8" name="fname" id="fname" placeholder="First Name" required>
											</div>
										</div>
										<div class="control-group">
											<label class="control-label" for="fname">Last Name</label>
											<div class="controls">
											<input type="text" class="span8" name="lname" id="lname" placeholder="Last Name" required>
											</div>
										</div>
										<div class="control-group">
