            ...
            <div class="row-fluid">
                ...
                <div class="span9" id="content">
                    ...
                    <div class="row-fluid" style="margin-left: 25px;">
                        ...
                        <!-- block -->
                        <div id="block_bg" class="bloc5k" style="box-shadow: none; border-radius:10px;">
                            <div class="navbar navbar-inner block-header"  style="border-radius: 10px;">
                                <div class="muted pull-left">Data Numbers</div>
                            </div>
                            <div class="block-content collapse in" style="border-radius: 10px;">
							        <div class="span12">
