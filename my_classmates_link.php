<div class="span3" id="sidebar"style="background:linear-gradient(rgb(80,208,249),rgb(0,73,96));height :94vh;margin-top:-19px;margin-left:-20px">
	<img id="avatar" style="border-radius: 50%;" src="admin/<?php echo $row['location']; ?>" >
		<ul class=""style="list-style: none;margin:30px;font-size:19px;">
				<li style="padding:10px"> <a href="dashboard_student.php"style="text-decoration: none;color:white;font-family:Sans-serif;"><i class="icon-chevron-left"></i>&nbsp;Back</a></li>
				<li style="padding:10px" class="active"><a href="my_classmates.php<?php echo '?id='.$get_id; ?>"style="text-decoration: none;color:white;font-family:Sans-serif;"><i class="icon-group"></i>&nbsp;My Classmates</a></li>
